...
comport = serial('Com3', 'BaudRate', 9600); % setup a serial port (ground teensy - Brian)
...
%     Pressure1 = 600*(Pressure1_tmp*3.3/1023.0)/(3.3/5*(4.58 - 2.19)) - 249.791*3.3/5;    % PCC
%     Pressure12 = 600*(Pressure12_tmp*3.3/1023.0)/(3.3/5*(4.58 - 2.19)) - 249.791*3.3/5;  % PFOX
%     Pressure13 = 300*(Pressure13_tmp*5.0/1023.0)/(3.3/5*(2.72 - 2.11)) - 737.705;  % PSOX

    Pressure1 = 700*(Pressure1_tmp*5.0/1023.0 - 0.97)/(3.51 - 0.97);    % PCC
    Pressure12 = 700*(Pressure12_tmp*5.0/1023.0 - 0.97)/(3.51 - 0.97);  % PFOX
    Pressure13 = 700*(Pressure13_tmp*5.0/1023.0 - 0.98)/(1.9 - 0.98);  % PSOX
