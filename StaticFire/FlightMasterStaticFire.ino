...
int LaunchSeq(){
  ...
  while (LaunchSeqEnd == 0) {
    ...
    if ((currentMillis - initMillis) > 60400 && moxv1OpenCounter == 0){
...
int Flight2Seq(){
  ...
  while (Flight2SeqEnd == 0 && STATE == 4){
    ...
    if ((currentMillis - initMillis) > 400 && moxv3OpenCounter == 0){
    ...
    if ((currentMillis - initMillis) > 10000 && Burn2Counter == 0 && STATE == 4){
      Burn2Counter = 1;
